...
doses = dosi.text
atd1 = atd.text
print ("\n\nDOSES RECEBIDAS: ({}) -------------------- {} ".format(doses, atd1))
...
dosesa = dosia.text
atda1 = atda.text
print ("\nDOSES APLICADAS: ({}) -------------------- {} ".format(dosesa, atda1))
...
dosesa1 = dosia1.text
atda11 = atda1.text
print ("\nPESSOAS QUE RECEBERAM A 1º DOSE: ({}) ---- {} ".format(dosesa1, atda11))
...
dosesa2 = dosia2.text
atda12 = atda2.text
print ("\nPESSOAS QUE RECEBERAM A 2º DOSE: ({}) ----- {} ".format(dosesa2, atda12))
